...
from .forms import UserProfileForm,UserForm,UserInfoForm
...
def myself_edit(request):
    ...
    if request.method=='POST':
        ...
        if userinfo_form.is_valid() and userprofile_form.is_valid() and user_form.is_valid():
